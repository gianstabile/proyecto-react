...
const item = {
  ...
  extDescription: "Dados eróticos para jugar en pareja. Indican partes del cuerpo y acciones a realizar. Dale un toque especial a tus noches de pasión. Vienen en una elegante bolsita.", 
